...
## Corpus Check
- 106 files · ~56,077 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1241 nodes · 1306 edges · 103 communities (80 shown, 23 thin omitted)
...
Cohesion: 0.12
Nodes (16): aee_config, ar, character_cutoff, de, ee_timeout_threshold_seconds, el, en, fr (+8 more)
...
## Knowledge Gaps
- **845 isolated node(s):** `java.compile.nullAnalysis.mode`, `CarreraRepository`, `TipoUsuarioRepository`, `UbicacionRepository`, `configVersion` (+840 more)
