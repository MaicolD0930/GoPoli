...
## Corpus Check
- 116 files · ~58,722 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1316 nodes · 1396 edges · 111 communities (86 shown, 25 thin omitted)
...
Cohesion: 0.07
Nodes (27): build, main, MaterialApp, MyApp, build, Card, _cargarServicios, Column (+19 more)
...
Cohesion: 0.15
Nodes (10): build, CrearServicioPage, _CrearServicioPageState, Scaffold, main, grupo_page.dart, package:flutter/material.dart, package:flutter_test/flutter_test.dart (+2 more)
...
Cohesion: 0.09
Nodes (20): build, _buildCarreraDropdown, Center, Column, dispose, initState, _mostrarSnack, RegistroPage (+12 more)

### Community 105 - "Community 105"
Cohesion: 0.15
Nodes (12): ApiException, AuthService, ApiException, CatalogoService, RouteService, ../config/config.dart, ../core/api_exception.dart, ../models/carrera.dart (+4 more)

### Community 106 - "Community 106"
Cohesion: 0.17
Nodes (11): build, dispose, _irAMapaViaje, MainShell, _MainShellState, PerfilPage, Scaffold, home_page.dart (+3 more)
...
## Knowledge Gaps
- **888 isolated node(s):** `java.compile.nullAnalysis.mode`, `CarreraRepository`, `TipoUsuarioRepository`, `UbicacionRepository`, `configVersion` (+883 more)
